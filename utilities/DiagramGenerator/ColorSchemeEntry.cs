...
public static class ColorSchemeEntry
{
	public static List<ColorEntry> FromColorScheme(ColorScheme scheme)
	{
		...
		List<ColorEntry> entries = new()
		{
			...
			new() { Index = "ac1", Name = "accent 1", HexCode     = $"#{scheme.Accent.Primary}" },
			new() { Index = "ac2", Name = "accent 2", HexCode     = $"#{scheme.Accent.Secondary}" },
			new() { Index = "ac3", Name = "accent 3", HexCode     = $"#{scheme.Accent.Tertiary}" },
			padding,
